                ...
                if (void 0 !== a) {
                    var t, c = u(this),
                        ...
                        e = {
                            initialize: function() {
                                var e, t = this;
                                c.data("pagination") || c.data("pagination", {}), !1 !== t.callHook("beforeInit") && (c.data("pagination").initialized && u(".paginationjs", c).remove(),
                        ...
                        button: v
                            ...
                            go: function(a, t) {
                                ...
                                r.disabled || (n = a, !(n = parseInt(n))) || n < 1 || (a = J.pageSize,
                                    o = r.getTotalNumber(),
                                    i = r.getTotalPage(),
                                        ...
                                        t.on("click", ".J-paginationjs-page", function(a) {
                                            ...
                                            if (t && !e.hasClass(J.disableClassName) && !e.hasClass(J.activeClassName))
                                                return !1 !== o.callHook("beforePageOnClick", a, t) && (o.go(t),
                                                    o.callHook("afterPageOnClick", a, t), !!J.pageLink) && void 0
                                        }),
                                        t.on("click", ".J-paginationjs-previous", function(a) {
                                            ...
                                            if (t && !e.hasClass(J.disableClassName))
                                                return !1 !== o.callHook("beforePreviousOnClick", a, t) && (o.go(t),
                                                    o.callHook("afterPreviousOnClick", a, t), !!J.pageLink) && void 0
                                        }),
                                        t.on("click", ".J-paginationjs-next", function(a) {
                                            ...
                                            if (t && !e.hasClass(J.disableClassName))
                                                return !1 !== o.callHook("beforeNextOnClick", a, t) && (o.go(t),
                                                    o.callHook("afterNextOnClick", a, t), !!J.pageLink) && void 0
                                        }),
                                        ...
                                        t.on("change", ".J-paginationjs-size-select", function(a) {
                                            ...
                                            if ("number" == typeof e)
                                                return !1 !== o.callHook("beforeSizeSelectorChange", a, e) && (J.pageSize = e,
                                                    ...
                                                    o.go(t),
                                                    o.callHook("afterSizeSelectorChange", a, e), !!J.pageLink) && void 0
                                        }),
